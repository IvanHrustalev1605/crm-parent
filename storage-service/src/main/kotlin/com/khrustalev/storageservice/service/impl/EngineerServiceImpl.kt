...
import com.khrustalev.storageservice.mappers.EngineerMapper
...
@Service
class EngineerServiceImpl(private var engineerRepository: EngineerRepository,
                          @Lazy private var engineerMapper: EngineerMapper) : EngineerService {
    ...
    override fun mapToDto(entity: Engineer): EngineerDto {
        return engineerMapper.toDto(entity)
    }
